        ...
        h.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(password.equals("0")){
                    Intent in=new Intent(getApplicationContext(),CreatePassword.class);
                    startActivity(in);
                    finish();
                }
                else{
                    Intent in=new Intent(getApplicationContext(),InputPassword.class);
                    startActivity(in);
                    finish();
                }
            }
        },2000);
        //Boolean isFirstR = getSharedPreferences("PREFERENCE", MODE_PRIVATE).getBoolean("isFirstR", true);
    }
    /*
